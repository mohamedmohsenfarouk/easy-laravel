				...
				<div class="content">
					<div class="row">
						...
						<div class="col-sm-4 col-7 text-right m-b-30">
							<a href="add-leave-type" class="btn btn-primary btn-rounded float-right"><i class="fas fa-plus"></i> Add Leave Type</a>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
										...
										<tr>
											...
											<td class="text-right">
												<div class="dropdown dropdown-action">
													...
													<div class="dropdown-menu dropdown-menu-right">
														<a class="dropdown-item" href="edit-leave-type"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a>
														<a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_leavetype"><i class="fas fa-trash m-r-5"></i> Delete</a>
													</div>
												</div>
											</td>
										</tr>
