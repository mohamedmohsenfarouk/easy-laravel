            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-5 col-6 text-right m-b-30">
                        <a href="<?php echo e(route('editprofile')); ?>" class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Edit Profile</a>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                ...
                                                <div class="staff-msg"><a href="<?php echo e(route('chat')); ?>" class="btn btn-primary">Send Message</a></div>
                                            </div>
                                        </div>
                                        <div class="col-md-7">
...
</html><?php /**PATH D:\xampp\htdocs\preclinic_laravel\resources\views/pages/profile.blade.php ENDPATH**/ ?>