            ...
            <div class="content">
					...
					<div class="col-12 col-md-6 col-lg-8 col-xl-8">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title d-inline-block">Upcoming Appointments</h4> <a href="<?php echo e(route('appointment')); ?>" class="btn btn-primary float-right">View all</a>
							</div>
										...
										<tbody>
											<tr>
												<td style="min-width: 200px;">
													<a class="avatar" href="<?php echo e(route('profile')); ?>">B</a>
													<h2><a href="<?php echo e(route('profile')); ?>">Bernardo Galaviz <span>New York, USA</span></a></h2>
												</td>                 
												<td>
												...
												<td class="text-right">
													<a href="<?php echo e(route('appointment')); ?>" class="btn btn-outline-primary take-btn">Take up</a>
												</td>
											</tr>
											<tr>
												<td style="min-width: 200px;">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-xl-4">
                        <div class="card member-panel">
                            ...
                            <div class="card-body">
                                <ul class="contact-list">
                                    <li>
                                        <div class="contact-cont">
                                            <div class="float-left user-img m-r-10">
                                                <a href="<?php echo e(route('profile')); ?>" title="John Doe"><img src="img/user.jpg" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
                                            </div>
                                    ...
                                    <li>
                                        <div class="contact-cont">
                                            <div class="float-left user-img m-r-10">
                                                <a href="<?php echo e(route('profile')); ?>" title="Richard Miles"><img src="img/user.jpg" alt="" class="w-40 rounded-circle"><span class="status offline"></span></a>
                                            </div>
                                            <div class="contact-info">
                                    ...
                                    <li>
                                        <div class="contact-cont">
                                            <div class="float-left user-img m-r-10">
                                                <a href="<?php echo e(route('profile')); ?>" title="John Doe"><img src="img/user.jpg" alt="" class="w-40 rounded-circle"><span class="status away"></span></a>
                                            </div>
                                            <div class="contact-info">
                                                <span class="contact-name text-ellipsis">John Doe</span>
                                    ...
                                    <li>
                                        <div class="contact-cont">
                                            <div class="float-left user-img m-r-10">
                                                <a href="<?php echo e(route('profile')); ?>" title="Richard Miles"><img src="img/user.jpg" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
                                            </div>
                                            <div class="contact-info">
                                                <span class="contact-name text-ellipsis">Richard Miles</span>
                                    ...
                                    <li>
                                        <div class="contact-cont">
                                            <div class="float-left user-img m-r-10">
                                                <a href="<?php echo e(route('profile')); ?>" title="John Doe"><img src="img/user.jpg" alt="" class="w-40 rounded-circle"><span class="status offline"></span></a>
                                            </div>
                                            <div class="contact-info">
                                                <span class="contact-name text-ellipsis">John Doe</span>
                                    ...
                                    <li>
                                        <div class="contact-cont">
                                            <div class="float-left user-img m-r-10">
                                                <a href="<?php echo e(route('profile')); ?>" title="Richard Miles"><img src="img/user.jpg" alt="" class="w-40 rounded-circle"><span class="status away"></span></a>
                                            </div>
                                            <div class="contact-info">
                                                <span class="contact-name text-ellipsis">Richard Miles</span>
                                                <span class="contact-date">MBBS, MD</span>
                            ...
                            <div class="card-footer text-center bg-white">
                                <a href="<?php echo e(route('doctor')); ?>" class="text-muted">View all Doctors</a>
                            </div>
                        </div>
                    </div>
				</div>
				<div class="row">
					<div class="col-12 col-md-6 col-lg-8 col-xl-8">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title d-inline-block">New Patients </h4> <a href="<?php echo e(route('patients')); ?>" class="btn btn-primary float-right">View all</a>
							</div>
									...
									<table class="table mb-0 new-patient-table">
										<tbody>
											<tr>
												...
												<td style="font-size:0.875rem !important;">Johndoe21@gmail.com</td>
											...
											<tr>
												...
												<td style="font-size:0.875rem !important;">Richard123@yahoo.com</td>
...
</html><?php /**PATH C:\xampp\htdocs\preclinic_laravel\resources\views/layout/nav.blade.php ENDPATH**/ ?>