						...
						<div class="table-responsive">
							<table class="table table-border table-striped custom-table datatable mb-0">
								...
								<tbody>
									<tr>
										...
										<td class="text-right">
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
													<a class="dropdown-item" href="<?php echo e(route('edit-patients')); ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
									...
									<tr>
										<td><img width="28" height="28" src="<?php echo e(route('edit-patients')); ?>" class="rounded-circle m-r-5" alt=""> Charles Ortega</td>
										<td>32</td>
									...
									<tr>
										<td><img width="28" height="28" src="<?php echo e(route('edit-patients')); ?>" class="rounded-circle m-r-5" alt=""> Sandra Mendez</td>
										<td>24</td>
...
</html><?php /**PATH C:\xampp\htdocs\preclinic_laravel\resources\views/pages/patients.blade.php ENDPATH**/ ?>