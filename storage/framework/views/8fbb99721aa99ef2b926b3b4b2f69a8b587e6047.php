					...
					<div class="crms-title row bg-white mb-4">
                		...
                		<div class="col p-0 text-right">
                			<ul class="breadcrumb bg-white float-right m-0 pl-0 pr-0">
								...
								<li class="breadcrumb-item active">Deals Kanban View</li>
							</ul>
                		</div>
                	</div>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\crms-laravel\template\resources\views/deals-kanban-view.blade.php ENDPATH**/ ?>