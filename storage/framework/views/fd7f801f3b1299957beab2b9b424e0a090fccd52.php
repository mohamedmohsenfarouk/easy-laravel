...
<div class="main-wrapper">
		...
		<div class="header">
				...
				<ul class="nav user-menu float-right">
					...
					<li class="nav-item dropdown d-none d-sm-block">
						<a href="javascript:void(0);" id="open_msg_box" class="hasnotifications nav-link"><i class="far fa-comment"></i> <span class="badge badge-pill bg-danger float-right">8</span></a>
					</li>
			...
			<?php /**PATH /home/keema/Documents/themeforest-Ke1Xa4Lj-medifab-health-medical-html-template/laravel/admin-template/resources/views/layout/partials/header.blade.php ENDPATH**/ ?>