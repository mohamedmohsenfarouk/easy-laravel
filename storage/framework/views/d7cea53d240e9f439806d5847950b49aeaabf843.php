	...
	<footer class="footer">
			...
			<?php if(Route::is(['schedule-timings'])): ?>
		<!-- Add Time Slot Modal -->
		...
		<!-- /Edit Time Slot Modal -->
	  <?php endif; ?>
	  <?php if(Route::is(['profile-mentee','profile'])): ?>
	  <!-- Voice Call Modal -->
		...
		<!-- /Appointment Details Modal -->
		<?php endif; ?><?php /**PATH C:\xampp\htdocs\Mentoring_laravel\template\resources\views/layout/partials/footer.blade.php ENDPATH**/ ?>