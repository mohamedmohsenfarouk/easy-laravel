                        ...
                        <div class="col text-right">
                            <ul class="list-inline-item pl-0">
                                <li class="list-inline-item">
                                    <button class="add btn btn-gradient-primary font-weight-bold text-white todo-list-add-btn btn-rounded" id="add-task" data-toggle="modal" data-target="#add_report">New Report</button>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 p-0">
                      <ul class="nav nav-tabs card p-0 mb-0" id="reports" role="tablist">
                        <li class="nav-item w-100">
                          <a class="nav-link active" data-toggle="tab" href="#personal-reports" role="tab" aria-controls="personal-reports">My Personal Reports</a>
                        </li>
                        <li class="nav-item w-100">
                          <a class="nav-link" data-toggle="tab" href="#shared-reports" role="tab" aria-controls="shared-reports">Shared Reports</a>
                        </li>
                        <li class="nav-item w-100">
                          <a class="nav-link" data-toggle="tab" href="#all-reports" role="tab" aria-controls="all-reports">All Reports</a>
                        </li>
                        <li class="nav-item w-100">
                          <a class="nav-link" data-toggle="tab" href="#task-reports" role="tab" aria-controls="task-reports">Task Reports</a>
                        </li>
                        <li class="nav-item w-100">
                          <a class="nav-link" data-toggle="tab" href="#contact-reports" role="tab" aria-controls="contact-reports">Contact Reports</a>
                        </li>
                         <li class="nav-item w-100">
                          <a class="nav-link" data-toggle="tab" href="#company-reports" role="tab" aria-controls="company-reports">Company Reports</a>
                        </li>
                         <li class="nav-item w-100">
                          <a class="nav-link" data-toggle="tab" href="#lead-reports" role="tab" aria-controls="lead-reports">Lead Reports</a>
                        </li>
                         <li class="nav-item w-100">
                          <a class="nav-link" data-toggle="tab" href="#deal-reports" role="tab" aria-controls="deal-reports">Deal Reports</a>
                        </li>
                         <li class="nav-item w-100">
                          <a class="nav-link" data-toggle="tab" href="#project-reports" role="tab" aria-controls="project-reports">Project Reports</a>
                        </li>
                         <li class="nav-item w-100">
                          <a class="nav-link" data-toggle="tab" href="#other-reports" role="tab" aria-controls="other-reports">Other Reports</a>
                        </li>
                      </ul>
                    </div>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\crms-laravel\template\resources\views/reports.blade.php ENDPATH**/ ?>