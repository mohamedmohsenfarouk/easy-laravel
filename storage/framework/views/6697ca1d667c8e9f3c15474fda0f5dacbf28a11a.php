            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-4 col-7 text-right m-b-30">
                        <a href="add-leave-type" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Leave Type</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="edit-leave-type"><i class="fa fa-pencil m-r-5"></i> Edit</a>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\preclinic_laravel\resources\views/leave-type.blade.php ENDPATH**/ ?>