                                ...
                                <div class="navbar">
                                    <div class="user-details mr-auto">
                                        <div class="float-left user-img m-r-10">
                                            <a href="<?php echo e(route('profile')); ?>" title="Jennifer Robinson"><img src="img/patient-thumb-02.jpg" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
                                        </div>
                                        <div class="user-info float-left">
                                            <a href="<?php echo e(route('profile')); ?>"><span class="font-bold">Jennifer Robinson</span> <i class="typing-text">Typing...</i></a>
                                    ...
                                    <ul class="nav custom-menu">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo e(route('voice-cal')); ?>"><i class="fa fa-phone"></i></a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo e(route('voice-cal')); ?>"><i class="fa fa-video-camera"></i></a>
                                        </li>
                                                ...
                                                <div class="chat chat-left">
                                                    <div class="chat-avatar">
                                                        <a href="<?php echo e(route('profile')); ?>" class="avatar">
                                                            <img alt="Jennifer Robinson" src="img/patient-thumb-02.jpg" class="img-fluid rounded-circle">
                                                        </a>
                                                    </div>
                                                    <div class="chat-body">
                                                        <div class="chat-bubble">
                                        ...
                                        <div class="chat-box">
                                            <div class="chats">
                                                <div class="chat chat-left">
                                                    <div class="chat-avatar">
                                                        <a href="<?php echo e(route('profile')); ?>" class="avatar">
                                                            <img alt="Cristina Groves" src="img/doctor-thumb-03.jpg" class="img-fluid rounded-circle">
                                                        </a>
                                                    </div>
                                                    <div class="chat-body">
                                                        <div class="chat-bubble">
...
</html><?php /**PATH C:\xampp\htdocs\blog1\resources\views/pages/chat.blade.php ENDPATH**/ ?>