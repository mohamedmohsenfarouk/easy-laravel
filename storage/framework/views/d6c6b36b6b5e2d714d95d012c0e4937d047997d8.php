                    ...
                    <ul>
						...
						<li class="submenu">
							...
							<ul style="display: none;">
								...
								<li><a class="active" href="<?php echo e(route('payments')); ?>">Payments</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-striped custom-table datatable mb-0">
                                <thead>
                                    <tr>
                                        <th style="font-size:0.875rem !important;">Invoice ID</th>
                                        <th style="font-size:0.875rem !important;">Patient</th>
                                        <th style="font-size:0.875rem !important;">Payment Type</th>
                                        <th style="font-size:0.875rem !important;">Paid Date</th>
                                        <th style="font-size:0.875rem !important;">Paid Amount</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td style="font-size:0.875rem !important;"><a href="<?php echo e(route('invoice-veiw')); ?>">#INV-0001</a></td>
                                        <td style="font-size:0.875rem !important;">
                                            <h2><a href="#">Charles Ortega</a></h2>
                                        </td>
                                        <td style="font-size:0.875rem !important;">Paypal</td>
                                        <td style="font-size:0.875rem !important;">8 Aug 2017</td>
                                        <td style="font-size:0.875rem !important;">$500</td>
                                    </tr>
                                    <tr>
...
</html><?php /**PATH C:\xampp\htdocs\blog1\resources\views/pages/payments.blade.php ENDPATH**/ ?>