<?php if(!Route::is(['add-leave-type','add-role','change-password','chat','compose','edit-leave-type','edit-role','email-settings','inbox','incoming-call','invoice-settings','leave-type','localization','mail-view','notifications-settings','roles-permissions','salary-settings','settings','theme-settings','video-call','voice-call'])): ?>
<div class="sidebar" id="sidebar">
				<div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						...
						<ul>
							...
							<li class="<?php echo e(Request::is('pagee') ? 'active' : ''); ?>">
								<a href="index"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
							</li>
							<li class="<?php echo e(Request::is('doctors','add-doctor','edit-doctor') ? 'active' : ''); ?>">
								<a href="doctors"><i class="fas fa-user-md"></i> Doctors</a>
							</li>
							<li class="<?php echo e(Request::is('patients','add-patient','edit-patient') ? 'active' : ''); ?>">
								<a href="patients"><i class="fas fa-wheelchair"></i> Patients</a>
							</li>
							<li class="<?php echo e(Request::is('appointments','add-appointment','add-asset','edit-appointment') ? 'active' : ''); ?>">
								<a href="appointments"><i class="far fa-calendar-alt"></i> Appointments</a>
							</li>
							<li class="<?php echo e(Request::is('schedule','add-schedule','edit-schedule') ? 'active' : ''); ?>">
								<a href="schedule"><i class="far fa-calendar-check"></i> Doctor Schedule</a>
							</li>
							<li class="<?php echo e(Request::is('departments','add-department','edit-department') ? 'active' : ''); ?>">
							...
							<li class="<?php echo e(Request::is('asset','edit-asset') ? 'active' : ''); ?>">
			...
			<?php endif; ?>
			<?php if(Route::is(['add-leave-type','add-role','change-password','edit-leave-type','edit-role','email-settings','invoice-settings','leave-type','localization','notifications-settings','roles-permissions','salary-settings','settings','theme-settings'])): ?>
			<div class="sidebar" id="sidebar">
				<div class="sidebar-inner slimscroll">
					<div class="sidebar-menu">
						<ul>
							...
							<li class="<?php echo e(Request::is('roles-permissions','add-role','edit-role') ? 'active' : ''); ?>">
							...
							<li class="<?php echo e(Request::is('leave-type','add-leave-type','edit-leave-type') ? 'active' : ''); ?>">
			...
			<?php endif; ?>
			<?php if(Route::is(['chat','incoming-call','video-call','voice-call'])): ?>
			<div class="sidebar" id="sidebar">
				<div class="sidebar-inner slimscroll">
					<div class="sidebar-menu">
						<ul>
							...
							<li class="<?php echo e(Request::is('chat','video-call','voice-call') ? 'active' : ''); ?>">
			...
			<?php endif; ?>
			<?php if(Route::is(['compose'])): ?>
			<div class="sidebar" id="sidebar">
				<div class="sidebar-inner slimscroll">
					<div class="sidebar-menu">
						<ul>
							<li class="<?php echo e(Request::is('inbox') ? 'active' : ''); ?>">
			...
			<?php endif; ?>
			<?php if(Route::is(['inbox','mail-view'])): ?>
			<div class="sidebar" id="sidebar">
				<div class="sidebar-inner slimscroll">
					<div class="sidebar-menu">
						<ul>
							...
							<li class="<?php echo e(Request::is('inbox','mail-view') ? 'active' : ''); ?>">
								<a href="inbox">Inbox <span class="mail-count">(21)</span></a>
							</li>
							<li>
								<a href="#">Starred</a>
			...
			<?php endif; ?><?php /**PATH /home/keema/Documents/themeforest-Ke1Xa4Lj-medifab-health-medical-html-template/laravel/admin-template/resources/views/layout/partials/nav.blade.php ENDPATH**/ ?>