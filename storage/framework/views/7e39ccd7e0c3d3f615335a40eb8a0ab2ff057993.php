                                                ...
                                                <ul class="contact-list">
                                                        ...
                                                        <div class="contact-cont">
                                                            <div class="float-left user-img">
                                                                <a href="profile" class="avatar">
                                                                    <img class="rounded-circle" alt="" src="img/profiles/avatar-02.jpg">
                                                    ...
                                                    <li>
                                                        <div class="contact-cont">
                                                            <div class="float-left user-img">
                                                                <a href="profile" class="avatar">
                                                                    <img class="rounded-circle" alt="" src="img/profiles/avatar-09.jpg">
                                                                    <span class="status online"></span>
                                                                </a>
                                                            </div>
                                                            <div class="contact-info">
                                                    ...
                                                    <li>
                                                        <div class="contact-cont">
                                                            <div class="float-left user-img">
                                                                <a href="profile" class="avatar">
                                                                    <img class="rounded-circle" alt="" src="img/profiles/avatar-10.jpg">
                                                                    <span class="status online"></span>
                                                                </a>
                                                            </div>
                                                            <div class="contact-info">
                                                    ...
                                                    <li>
                                                        <div class="contact-cont">
                                                            <div class="float-left user-img">
                                                                <a href="profile" class="avatar">
                                                                    <img class="rounded-circle" alt="" src="img/profiles/avatar-05.jpg">
                                                                    <span class="status online"></span>
                                                                </a>
                                                            </div>
                                                            <div class="contact-info">
                                                    ...
                                                    <li>
                                                        <div class="contact-cont">
                                                            <div class="float-left user-img">
                                                                <a href="profile" class="avatar">
                                                                    <img class="rounded-circle" alt="" src="img/profiles/avatar-11.jpg">
                                                                    <span class="status online"></span>
                                                                </a>
                                                            </div>
                                                            <div class="contact-info">
                                                    ...
                                                    <li>
                                                        <div class="contact-cont">
                                                            <div class="float-left user-img">
                                                                <a href="profile" class="avatar">
                                                                    <img class="rounded-circle" alt="" src="img/profiles/avatar-12.jpg">
                                                                    <span class="status online"></span>
                                                                </a>
                                                            </div>
                                                            <div class="contact-info">
                                                    ...
                                                    <li>
                                                        <div class="contact-cont">
                                                            <div class="float-left user-img">
                                                                <a href="profile" class="avatar">
                                                                    <img class="rounded-circle" alt="" src="img/profiles/avatar-13.jpg">
                                                                    <span class="status online"></span>
                                                                </a>
                                                            </div>
                                                            <div class="contact-info">
                                                    ...
                                                    <li>
                                                        <div class="contact-cont">
                                                            <div class="float-left user-img">
                                                                <a href="profile" class="avatar">
                                                                    <img class="rounded-circle" alt="" src="img/profiles/avatar-01.jpg">
                                                                    <span class="status online"></span>
                                                                </a>
                                                            </div>
                                                            <div class="contact-info">
                                                    ...
                                                    <li>
                                                        <div class="contact-cont">
                                                            <div class="float-left user-img">
                                                                <a href="profile" class="avatar">
                                                                    <img class="rounded-circle" alt="" src="img/profiles/avatar-16.jpg">
                                                                    <span class="status online"></span>
                                                                </a>
                                                            </div>
                                                            <div class="contact-info">
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\smarthr_laravel\resources\views/contacts.blade.php ENDPATH**/ ?>