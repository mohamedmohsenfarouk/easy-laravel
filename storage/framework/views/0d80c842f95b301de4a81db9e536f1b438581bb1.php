						...
						<div class="col-md-8 offset-md-2">
							<form>
								...
								<div class="form-group row">
									...
									<div class="col-lg-9">
										<input name="website_name" class="form-control" value="Medifab" type="text">
									</div>
								</div>
								<div class="form-group row">
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\medifab-laravel\admin-template\resources\views/theme-settings.blade.php ENDPATH**/ ?>