            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-4 col-7 text-right m-b-30">
                        <a href="<?php echo e(route('add-leave-type')); ?>" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Leave Type</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="<?php echo e(route('edit-leave-type')); ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
...
</html><?php /**PATH C:\xampp\htdocs\blog1\resources\views/pages/leave-type.blade.php ENDPATH**/ ?>