...
<div class="sidebar" id="sidebar">
					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="<?php echo e(Request::is('admin-index') ? 'active' : ''); ?>"> 
								<a href="admin-index"><i class="fe fe-home"></i> <span>Dashboard</span></a>
							</li>
							...
							<li  class="<?php echo e(Request::is('admin-blank-page','admin-calendar') ? 'active' : ''); ?>"> 
								<a href="admin-blank-page"><i class="fe fe-file"></i> <span>Blank Page</span></a>
							</li>
							<li class="menu-title"> 
								<span>UI Interface</span>
							</li>
							<li class="<?php echo e(Request::is('admin-components') ? 'active' : ''); ?>"> 
								<a href="admin-components"><i class="fe fe-vector"></i> <span>Components</span></a>
							</li>
							<li class="submenu">
			...
			<!-- /Sidebar --><?php /**PATH C:\xampp\htdocs\doccure_laravel\template_landing\resources\views/layout/partials/nav_admin.blade.php ENDPATH**/ ?>