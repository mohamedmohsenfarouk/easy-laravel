                    ...
                    <ul>
						...
						<li class="submenu">
							...
							<ul style="display: none;">
								...
								<li><a class="active" href="<?php echo e(route('attendance')); ?>">Attendance</a></li>
							</ul>
						</li>
						<li class="submenu">
                    ...
                    <div class="col-lg-12">
						<div class="table-responsive">
                            <table class="table table-striped custom-table mb-0">
                                <thead>
                                    <tr>
                                        <th style="font-size:0.875rem !important;">Employee</th>
                                        <th style="font-size:0.875rem !important;">1</th>
                                        <th style="font-size:0.875rem !important;">2</th>
                                        <th style="font-size:0.875rem !important;">3</th>
                                        <th style="font-size:0.875rem !important;">4</th>
                                        <th style="font-size:0.875rem !important;">5</th>
                                        <th style="font-size:0.875rem !important;">6</th>
                                        <th style="font-size:0.875rem !important;">7</th>
                                        <th style="font-size:0.875rem !important;">8</th>
                                        <th style="font-size:0.875rem !important;">9</th>
                                        <th style="font-size:0.875rem !important;">10</th>
                                        <th style="font-size:0.875rem !important;">11</th>
                                        <th style="font-size:0.875rem !important;">12</th>
                                        <th style="font-size:0.875rem !important;">13</th>
                                        <th style="font-size:0.875rem !important;">14</th>
                                        <th style="font-size:0.875rem !important;">15</th>
                                        <th style="font-size:0.875rem !important;">16</th>
                                        <th style="font-size:0.875rem !important;">17</th>
                                        <th style="font-size:0.875rem !important;">18</th>
                                        <th style="font-size:0.875rem !important;">19</th>
                                        <th style="font-size:0.875rem !important;">20</th>
                                        <th style="font-size:0.875rem !important;">22</th>
                                        <th style="font-size:0.875rem !important;">23</th>
                                        <th style="font-size:0.875rem !important;">24</th>
                                        <th style="font-size:0.875rem !important;">25</th>
                                        <th style="font-size:0.875rem !important;">26</th>
                                        <th style="font-size:0.875rem !important;">27</th>
                                        <th style="font-size:0.875rem !important;">28</th>
                                        <th style="font-size:0.875rem !important;">29</th>
                                        <th style="font-size:0.875rem !important;">30</th>
                                        <th style="font-size:0.875rem !important;">31</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td style="font-size:0.875rem !important;">Albina Simonis</td>
                                    ...
                                    <tr>
                                        <td style="font-size:0.875rem !important;">Cristina Groves</td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                    ...
                                    <tr>
                                        <td style="font-size:0.875rem !important;">Haylie Feeney</td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                    ...
                                    <tr>
                                        <td style="font-size:0.875rem !important;">Mary Mericle</td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                    ...
                                    <tr>
                                        <td style="font-size:0.875rem !important;">Zoe Butler</td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                    ...
                                    <tr>
                                        <td style="font-size:0.875rem !important;">Marie Wells</td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                    ...
                                    <tr>
                                        <td style="font-size:0.875rem !important;">Henry Daniels</td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                    ...
                                    <tr>
                                        <td style="font-size:0.875rem !important;">Mark Hunter</td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                    ...
                                    <tr>
                                        <td style="font-size:0.875rem !important;">Michael Sullivan</td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                        <td><i class="fa fa-check text-success"></i> </td>
                                        <td><i class="fa fa-check text-success"></i> </td>
...
</html><?php /**PATH C:\xampp\htdocs\blog1\resources\views/pages/attendance.blade.php ENDPATH**/ ?>