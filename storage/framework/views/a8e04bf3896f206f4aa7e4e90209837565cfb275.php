                                ...
                                <ul class="activity-list">
                                    <li>
                                        <div class="activity-user">
                                            <a href="<?php echo e(route('profile')); ?>" title="Lesley Grauer" data-toggle="tooltip" class="avatar">
                                                <img alt="Lesley Grauer" src="img/user.jpg" class="img-fluid rounded-circle">
                                            </a>
                                        </div>
                                        <div class="activity-content">
                                            <div class="timeline-content">
                                                <a href="<?php echo e(route('profile')); ?>" class="name">Lesley Grauer</a> added new task <a href="#">Hospital Administration</a>
                                    ...
                                    <li>
                                        <div class="activity-user">
                                            <a href="<?php echo e(route('profile')); ?>" class="avatar" title="Jeffery Lalor" data-toggle="tooltip">L</a>
                                        </div>
                                        <div class="activity-content">
                                            <div class="timeline-content">
                                                <a href="<?php echo e(route('profile')); ?>" class="name">Jeffery Lalor</a> added <a href="<?php echo e(route('profile')); ?>" class="name">Loren Gatlin</a> and <a href="<?php echo e(route('profile')); ?>" class="name">Tarah Shropshire</a> to project <a href="#">Patient appointment booking</a>
                                    ...
                                    <li>
                                        <div class="activity-user">
                                            <a href="<?php echo e(route('profile')); ?>" title="Catherine Manseau" data-toggle="tooltip" class="avatar">
                                                <img alt="Catherine Manseau" src="img/user.jpg" class="img-fluid rounded-circle">
                                            </a>
                                        </div>
                                        <div class="activity-content">
                                            <div class="timeline-content">
                                                <a href="<?php echo e(route('profile')); ?>" class="name">Catherine Manseau</a> completed task <a href="#">Appointment booking with payment gateway</a>
                                    ...
                                    <li>
                                        <div class="activity-user">
                                            <a href="#" title="Bernardo Galaviz" data-toggle="tooltip" class="avatar">
                                                <img alt="Bernardo Galaviz" src="img/user.jpg" class="img-fluid rounded-circle">
                                            </a>
                                        </div>
                                        <div class="activity-content">
                                            <div class="timeline-content">
                                                <a href="<?php echo e(route('profile')); ?>" class="name">Bernardo Galaviz</a> changed the task name <a href="#">Doctor available module</a>
                                    ...
                                    <li>
                                        <div class="activity-user">
                                            <a href="<?php echo e(route('profile')); ?>" title="Mike Litorus" data-toggle="tooltip" class="avatar">
                                                <img alt="Mike Litorus" src="img/user.jpg" class="img-fluid rounded-circle">
                                            </a>
                                        </div>
                                        <div class="activity-content">
                                            <div class="timeline-content">
                                                <a href="<?php echo e(route('profile')); ?>" class="name">Mike Litorus</a> added new task <a href="#">Patient and Doctor video conferencing</a>
                                    ...
                                    <li>
                                        <div class="activity-user">
                                            <a href="<?php echo e(route('profile')); ?>" title="Jeffery Lalor" data-toggle="tooltip" class="avatar">
                                                <img alt="Jeffery Lalor" src="img/user.jpg" class="img-fluid rounded-circle">
                                            </a>
                                        </div>
                                        <div class="activity-content">
                                            <div class="timeline-content">
                                                <a href="<?php echo e(route('profile')); ?>" class="name">Jeffery Lalor</a> added <a href="<?php echo e(route('profile')); ?>" class="name">Jeffrey Warden</a> and <a href="<?php echo e(route('profile')); ?>" class="name">Bernardo Galaviz</a> to the task of <a href="#">Private chat module</a>
...
</html><?php /**PATH C:\xampp\htdocs\blog1\resources\views/pages/activities.blade.php ENDPATH**/ ?>