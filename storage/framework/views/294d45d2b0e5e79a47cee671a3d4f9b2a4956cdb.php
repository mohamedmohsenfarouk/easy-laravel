            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a class="active" href="<?php echo e(route('sched')); ?>"><i class="fa fa-calendar-check-o"></i> <span>Doctor Schedule</span></a>
                        </li>
                        <li>
							...
							<table class="table table-border table-striped custom-table mb-0">
								<thead>
									<tr>
										...
										<th style="font-size:0.875rem !important;">Available Days</th>
										<th style="font-size:0.875rem !important;">Available Time</th>
								...
								<tbody>
									<tr>
										<td style="font-size:0.875rem !important;"><img width="28" height="28" src="img/user.jpg" class="rounded-circle m-r-5" alt=""> Henry Daniels</td>
										<td style="font-size:0.875rem !important;">Cardiology</td>
										<td style="font-size:0.875rem !important;">Sunday, Monday, Tuesday</td>
										<td style="font-size:0.875rem !important;">10:00 AM - 7:00 PM</td>
										<td style="font-size:0.875rem !important;"><span class="custom-badge status-green">Active</span></td>
										<td class="text-right">
											<div class="dropdown dropdown-action">
												<a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
												<div class="dropdown-menu dropdown-menu-right">
													<a class="dropdown-item" href="<?php echo e(route('edit-schedule')); ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
...
</html><?php /**PATH D:\xampp\htdocs\preclinic_laravel\resources\views/pages/sched.blade.php ENDPATH**/ ?>