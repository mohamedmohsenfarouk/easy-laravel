...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="plugins/summernote/dist/summernote-bs4.css">
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                <div class="sidebar-menu">
                    <ul>
                        <li>
                            <a href="<?php echo e(route('inbox')); ?>"><i class="fa fa-home back-icon"></i> <span>Back to Inbox</span></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('inbox')); ?>">Inbox <span class="mail-count">(21)</span></a>
                        </li>
                        <li>
                            <a href="#">Starred</a>
                        </li>
...
</html><?php /**PATH C:\xampp\htdocs\blog1\resources\views/pages/compose.blade.php ENDPATH**/ ?>