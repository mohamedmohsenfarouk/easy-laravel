                            ...
                            <table class="table table-striped custom-table mb-0 datatable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a href="job-applicants" class="btn btn-sm btn-primary">3 Candidates</a></td>
                                        <td class="text-right">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="job-applicants" class="btn btn-sm btn-primary">2 Candidates</a></td>
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="job-applicants" class="btn btn-sm btn-primary">1 Candidates</a></td>
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                                <div class="dropdown-menu dropdown-menu-right">
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\smarthr_laravel\resources\views/jobs.blade.php ENDPATH**/ ?>