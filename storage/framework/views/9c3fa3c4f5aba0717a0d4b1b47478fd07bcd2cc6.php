				...
				<div class="content">
					<div class="row">
						...
						<div class="col-sm-4 col-6 text-right m-b-30">
							<a href="add-leave" class="btn btn-primary btn-rounded float-right"><i class="fas fa-plus"></i> Add Leave</a>
						</div>
					</div>
							...
							<div class="table-responsive">
								<table class="table table-striped custom-table m-b-0 datatable">
									...
									<tbody>
										<tr>
											...
											<td class="text-right">
												<div class="dropdown dropdown-action">
													...
													<div class="dropdown-menu dropdown-menu-right">
														<a class="dropdown-item" href="edit-leave"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a></li>
														<a class="dropdown-item" href="#" title="Decline" data-toggle="modal" data-target="#delete_approve"><i class="fas fa-trash m-r-5"></i> Delete</a></li>
													</div>
												</div>
											</td>
										</tr>
										<tr>
											<td>
												<a href="profile" class="avatar">J</a>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\medifab-laravel\admin-template\resources\views/leaves.blade.php ENDPATH**/ ?>