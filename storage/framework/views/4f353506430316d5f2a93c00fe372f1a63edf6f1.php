                            ...
                            <table class="table table-striped custom-table mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="font-size:0.875rem !important;">Invoice Number</th>
                                        <th style="font-size:0.875rem !important;">Patient</th>
                                        <th style="font-size:0.875rem !important;">Created Date</th>
                                        <th style="font-size:0.875rem !important;">Due Date</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="font-size:0.875rem !important;"><a href="invoice-view.html">#INV-0001</a></td>
                                        <td style="font-size:0.875rem !important;">Charles Ortega</td>
                                        <td style="font-size:0.875rem !important;">1 Aug 2018</td>
                                        <td style="font-size:0.875rem !important;">7 Aug 2018</td>
                                        <td style="font-size:0.875rem !important;">$20</td>
                                        <td ><span class="custom-badge status-green">Paid</span></td>
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="<?php echo e(route('edit-invoice')); ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                    <a class="dropdown-item" href="<?php echo e(route('invoice-veiw')); ?>"><i class="fa fa-eye m-r-5"></i> View</a>
									...
									<tr>
                                        ...
                                        <td style="font-size:0.875rem !important;"><a href="<?php echo e(route('invoice-veiw')); ?>">#INV-0002</a></td>
                                        <td style="font-size:0.875rem !important;">Denise Stevens</td>
                                        <td style="font-size:0.875rem !important;">24 Aug 2018</td>
                                        <td style="font-size:0.875rem !important;">24 Aug 2018</td>
									...
									<tr>
                                        ...
                                        <td style="font-size:0.875rem !important;"><a href="<?php echo e(route('invoice-veiw')); ?>">#INV-0003</a></td>
                                        <td style="font-size:0.875rem !important;">Dennis Salazar</td>
                                        <td style="font-size:0.875rem !important;">1 Sep 2018</td>
                                        <td style="font-size:0.875rem !important;">7 Sep 2018</td>
                                        <td style="font-size:0.875rem !important;">$20</td>
...
</html><?php /**PATH C:\xampp\htdocs\blog1\resources\views/pages/invoices.blade.php ENDPATH**/ ?>