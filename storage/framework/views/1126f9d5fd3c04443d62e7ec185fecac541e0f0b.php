            ...
            <div class="sidebar-inner slimscroll">
                <div class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo e(route('chat')); ?>">#General</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('chat')); ?>">#Video Responsive Survey</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('chat')); ?>">#500rs</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('chat')); ?>">#warehouse</a>
                        </li>
                        ...
                        <li>
                            <a href="<?php echo e(route('chat')); ?>"><span class="chat-avatar-sm user-img"><img src="img/user.jpg" alt="" class="rounded-circle"><span class="status online"></span></span> John Doe <span class="badge badge-pill bg-danger float-right">1</span></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('chat')); ?>"><span class="chat-avatar-sm user-img"><img src="img/user.jpg" alt="" class="rounded-circle"><span class="status offline"></span></span> Richard Miles <span class="badge badge-pill bg-danger float-right">18</span></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('chat')); ?>"><span class="chat-avatar-sm user-img"><img src="img/user.jpg" alt="" class="rounded-circle"><span class="status away"></span></span> John Smith</a>
                        </li>
                        <li class="active">
                            <a href="<?php echo e(route('chat')); ?>"><span class="chat-avatar-sm user-img"><img src="img/user.jpg" alt="" class="rounded-circle"><span class="status online"></span></span> Mike Litorus <span class="badge badge-pill bg-danger float-right">108</span></a>
                        </li>
                    </ul>
                </div>
            </div>
								...
								<div class="navbar">
                                    <div class="user-details mr-auto">
                                        <div class="float-left user-img m-r-10">
                                            <a href="<?php echo e(route('profile')); ?>" title="Mike Litorus"><img src="img/user.jpg" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
                                        </div>
                                        <div class="user-info float-left">
                                            <a href="<?php echo e(route('profile')); ?>" title="Mike Litorus"><span class="font-bold">Mike Litorus</span></a>
                            ...
                            <div class="chat-contents">
                                <div class="chat-content-wrap">
                                    <div class="voice-call-avatar">
                                        <img src="img/user-03.jpg" alt="" class="call-avatar">
                                    ...
                                    <div class="call-users">
                                        <ul>
                                            <li>
                                                <a href="">
                                                    <img src="img/user-04.jpg" class="img-fluid" alt="">
                                                    <span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="">
                                                    <img src="img/user-05.jpg" class="img-fluid" alt="">
                                                    <span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="">
                                                    <img src="img/user-06.jpg" class="img-fluid" alt="">
                                                    <span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
                                                </a>
                                            </li>
                                        </ul>
                                            ...
                                            <div class="chats">
                                                <div class="chat chat-left">
                                                    <div class="chat-avatar">
                                                        <a href="<?php echo e(route('profile')); ?>" class="avatar">
                                                            <img alt="John Doe" src="img/user.jpg" class="img-fluid rounded-circle">
                                                        </a>
                                                    </div>
                                                    <div class="chat-body">
                                                    ...
                                                    <div class="chat-box">
                                                        <div class="chats">
                                                            ...
                                                            <div class="chat chat-left">
                                                                <div class="chat-avatar">
                                                                    <a href="<?php echo e(route('profile')); ?>" class="avatar">
                                                                        <img alt="Jeffery Lalor" src="img/user.jpg" class="img-fluid rounded-circle">
                                                                    </a>
                                                                </div>
                                                                <div class="chat-body">
                                                                    <div class="chat-bubble">
                                                                        ...
                                                                        <div class="chat-content">
                                                                            ...
                                                                            <ul class="attach-list">
                                                                                <li class="img-file">
                                                                                    ...
                                                                                    <div class="attach-img"><img src="img/user.jpg" alt=""></div>
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                            ...
                                            <div class="table-body">
                                                <div class="table-content">
                                                    <div class="chat-profile-img">
                                                        ...
                                                        <a href="<?php echo e(route('editprofile')); ?>" class="btn btn-primary edit-btn"><i class="fa fa-pencil"></i></a>
                                                    </div>
                ...
                <div class="modal-body">
                    <div class="profile-widget">
                        <div class="profile-img">
                            <a href="<?php echo e(route('profile')); ?>" class="avatar"><img src="img/user-03.jpg" alt=""></a>
                        </div>
                        <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="<?php echo e(route('profile')); ?>">Tressa Wexler</a></h4>
                        <div class="small text-muted">calling ...</div>
                        <div class="incoming-btns">
                            <a href="<?php echo e(route('chat')); ?>" class="btn btn-success m-r-10">Decline</a>
                            <a href="<?php echo e(route('profile')); ?>" class="btn btn-danger">Answer</a>
                        </div>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\blog1\resources\views/pages/incoming-cal.blade.php ENDPATH**/ ?>