            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="<?php echo e(route('add-appointment')); ?>" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Appointment</a>
                    </div>
                </div>
				<div class="row">
					<div class="col-md-12">
						<div class="table-responsive">
							<table class="table table-striped custom-table">
								<thead>
									<tr>
										<th style="font-size:0.875rem !important;">Appointment ID</th>
										<th style="font-size:0.875rem !important;">Patient Name</th>
										<th style="font-size:0.875rem !important;">Age</th>
										<th style="font-size:0.875rem !important;">Doctor Name</th>
										<th style="font-size:0.875rem !important;">Department</th>
										<th style="font-size:0.875rem !important;">Appointment Date</th>
										<th style="font-size:0.875rem !important;">Appointment Time</th>
								...
								<tbody>
									<tr>
										<td style="font-size:0.875rem !important;">APT0001</td>
										<td style="font-size:0.875rem !important;"><img width="28" height="28" src="img/user.jpg" class="rounded-circle m-r-5" alt=""> Denise Stevens</td>
										<td style="font-size:0.875rem !important;">35</td>
										<td style="font-size:0.875rem !important;">Henry Daniels</td>
										<td style="font-size:0.875rem !important;">Cardiology</td>
										<td style="font-size:0.875rem !important;">30 Dec 2018</td>
										<td style="font-size:0.875rem !important;">10:00am - 11:00am</td>
										<td style="font-size:0.875rem !important;"><span class="custom-badge status-red">Inactive</span></td>
										<td class="text-right">
											<div class="dropdown dropdown-action">
												<a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
												<div class="dropdown-menu dropdown-menu-right">
													<a class="dropdown-item" href="<?php echo e(route('edit-appointment')); ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
...
</html><?php /**PATH C:\xampp\htdocs\preclinic_laravel\resources\views/pages/appointment.blade.php ENDPATH**/ ?>