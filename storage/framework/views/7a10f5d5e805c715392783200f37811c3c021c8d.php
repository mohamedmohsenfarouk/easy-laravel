                    ...
                    <ul>
						...
						<li class="submenu">
							...
							<ul style="display: none;">
								...
								<li><a class="active" href="<?php echo e(route('leave')); ?>">Leaves</a></li>
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-4 col-6 text-right m-b-30">
                        <a href="<?php echo e(route('add-leave')); ?>" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Leave</a>
                    </div>
                </div>
                            ...
                            <table class="table table-striped custom-table mb-0 datatable">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="font-size:0.875rem !important;">Leave Type</th>
                                        <th style="font-size:0.875rem !important;">From</th>
                                        <th style="font-size:0.875rem !important;">To</th>
                                        <th style="font-size:0.875rem !important;">No of Days</th>
                                        <th style="font-size:0.875rem !important;">Reason</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <a href="<?php echo e(route('profile')); ?>" class="avatar">R</a>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="<?php echo e(route('edit-leave')); ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="<?php echo e(route('profile')); ?>" class="avatar">J</a>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="<?php echo e(route('profile')); ?>" class="avatar">H</a>
...
</html><?php /**PATH C:\xampp\htdocs\blog1\resources\views/pages/leave.blade.php ENDPATH**/ ?>