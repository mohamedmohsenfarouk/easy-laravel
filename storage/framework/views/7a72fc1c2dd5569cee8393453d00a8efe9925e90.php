            ...
            <div class="sidebar-inner slimscroll">
                <div class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="chat.html"><span class="chat-avatar-sm user-img"><img src="img/user.jpg" alt="" class="rounded-circle"><span class="status away"></span></span> John Smith</a>
                        </li>
                        <li class="active">
                            <a href="chat"><span class="chat-avatar-sm user-img"><img src="img/user.jpg" alt="" class="rounded-circle"><span class="status online"></span></span> Jennifer <span class="badge badge-pill bg-danger float-right">108</span></a>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <div class="navbar">
                                    <div class="user-details mr-auto">
                                        <div class="float-left user-img m-r-10">
                                            <a href="profile" title="Jennifer Robinson"><img src="img/patient-thumb-02.jpg" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
                                        </div>
                                        <div class="user-info float-left">
                                            <a href="profile"><span class="font-bold">Jennifer Robinson</span> <i class="typing-text">Typing...</i></a>
                                    ...
                                    <ul class="nav custom-menu">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="voice-call"><i class="fa fa-phone"></i></a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="video-call"><i class="fa fa-video-camera"></i></a>
                                        </li>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\preclinic_laravel\resources\views/chat.blade.php ENDPATH**/ ?>