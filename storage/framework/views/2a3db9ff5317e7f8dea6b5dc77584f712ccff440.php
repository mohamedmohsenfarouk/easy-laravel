                    ...
                    <ul>
						...
						<li class="submenu">
							...
							<ul style="display: none;">
								<li><a class="active" href="<?php echo e(route('employee')); ?>">Employees List</a></li>
                    ...
                    <div class="col-md-12">
						<div class="table-responsive">
                            <table class="table table-striped custom-table">
                                <thead>
                                    <tr>
                                        <th style="font-size:o.875rem !important;min-width:200px;">Name</th>
                                        <th style="font-size:0.875rem !important;">Employee ID</th>
                                        <th style="font-size:0.875rem !important;">Email</th>
                                        <th style="font-size:0.875rem !important;">Mobile</th>
                                        <th style="font-size:0.875rem !important; min-width: 110px;">Join Date</th>
                                        <th style="font-size:0.875rem !important;">Role</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
											<img width="28" height="28" src="img/user.jpg" class="rounded-circle" alt=""> <h2 style="font-size:0.875rem !important;">Albina Simonis</h2>
										</td>
                                        <td style="font-size:0.875rem !important;">NS-0001</td>
                                        <td style="font-size:0.875rem !important;">albinasimonis@example.com</td>
                                        <td style="font-size:0.875rem !important;">828-634-2744</td>
                                        <td style="font-size:0.875rem !important;">7 May 2015</td>
                                        <td>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="<?php echo e(route('edit-employee')); ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                    ...
                                    <tr>
                                        <td>
											<img width="28" height="28" src="img/user.jpg" class="rounded-circle" alt=""> <h2 style="font-size:0.875rem !important;">Cristina Groves</h2>
										</td>
                                        <td style="font-size:0.875rem !important;">DR-0001</td>
                                        <td style="font-size:0.875rem !important;">cristinagroves@example.com</td>
                                        <td style="font-size:0.875rem !important;">928-344-5176</td>
                                        <td style="font-size:0.875rem !important;">1 Jan 2013</td>
                                        <td>
									...
									<tr>
                                        <td>
											<img width="28" height="28" src="img/user.jpg" class="rounded-circle" alt=""> <h2 style="font-size:0.875rem !important;">Mary Mericle</h2>
										</td>
                                        <td style="font-size:0.875rem !important;">SF-0003</td>
                                        <td style="font-size:0.875rem !important;">marymericle@example.com</td>
                                        <td style="font-size:0.875rem !important;">603-831-4983</td>
                                        <td style="font-size:0.875rem !important;">27 Dec 2017</td>
                                        <td>
									...
									<tr>
                                        <td>
											<img width="28" height="28" src="img/user.jpg" class="rounded-circle" alt=""> <h2 style="font-size:0.875rem !important;">Haylie Feeney</h2>
										</td>
                                        <td style="font-size:0.875rem !important;">SF-0002</td>
                                        <td style="font-size:0.875rem !important;">hayliefeeney@example.com</td>
                                        <td style="font-size:0.875rem !important;">616-774-4962</td>
                                        <td style="font-size:0.875rem !important;">21 Apr 2017</td>
                                        <td>
									...
									<tr>
                                        <td>
											<img width="28" height="28" src="img/user.jpg" class="rounded-circle" alt=""> <h2 style="font-size:0.875rem !important;">Zoe Butler</h2>
										</td>
                                        <td style="font-size:0.875rem !important;">SF-0001</td>
                                        <td style="font-size:0.875rem !important;">zoebutler@example.com</td>
                                        <td style="font-size:0.875rem !important;">444-555-9999</td>
                                        <td style="font-size:0.875rem !important;">19 May 2012</td>
                                        <td>
...
</html><?php /**PATH C:\xampp\htdocs\blog1\resources\views/pages/employee.blade.php ENDPATH**/ ?>