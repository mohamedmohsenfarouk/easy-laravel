            ...
            <div class="sidebar-inner slimscroll">
                <div class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo e(route('roles-permissions')); ?>"><i class="fa fa-key"></i> <span>Roles & Permissions</span></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('email-settings')); ?>"><i class="fa fa-envelope-o"></i> <span>Email Settings</span></a>
                        </li>
                        <li class="active">
                            <a href="<?php echo e(route('invoice-settins')); ?>"><i class="fa fa-pencil-square-o"></i> <span>Invoice Settings</span></a>
                        </li>
                        <li>
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <form>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-2">
                                    <div class="img-thumbnail float-right"><img src="img/logo-dark.png" class="img-fluid" alt="" width="100" height="100"></div>
                                </div>
                            </div>
...
</html><?php /**PATH C:\xampp\htdocs\blog1\resources\views/pages/invoice-settings.blade.php ENDPATH**/ ?>