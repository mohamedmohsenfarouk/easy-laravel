            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="<?php echo e(route('add-doctor')); ?>" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Doctor</a>
                    </div>
                </div>
				<div class="row doctor-grid">
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            <div class="doctor-img">
                                <a class="avatar" href="<?php echo e(route('profile')); ?>"><img alt="" src="img/doctor-thumb-03.jpg"></a>
                            </div>
                            <div class="dropdown profile-action">
                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="<?php echo e(route('edit-doctor')); ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_doctor"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                </div>
                            </div>
                            <h4 class="doctor-name text-ellipsis"><a href="<?php echo e(route('profile')); ?>">Cristina Groves</a></h4>
                    ...
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            <div class="doctor-img">
                                <a class="avatar" href="<?php echo e(route('profile')); ?>"><img alt="" src="img/doctor-thumb-07.jpg"></a>
                            </div>
                            <div class="dropdown profile-action">
                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <h4 class="doctor-name text-ellipsis"><a href="<?php echo e(route('profile')); ?>">Marie Wells</a></h4>
                    ...
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            <div class="doctor-img">
                                <a class="avatar" href="<?php echo e(route('profile')); ?>"><img alt="" src="img/doctor-thumb-04.jpg"></a>
                            </div>
                            <div class="dropdown profile-action">
                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <h4 class="doctor-name text-ellipsis"><a href="<?php echo e(route('profile')); ?>">Henry Daniels</a></h4>
                    ...
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            <div class="doctor-img">
                                <a class="avatar" href="<?php echo e(route('profile')); ?>"><img alt="" src="img/doctor-thumb-11.jpg"></a>
                            </div>
                            <div class="dropdown profile-action">
                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <h4 class="doctor-name text-ellipsis"><a href="<?php echo e(route('profile')); ?>">Mark Hunter</a></h4>
                    ...
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            ...
                            <h4 class="doctor-name text-ellipsis"><a href="<?php echo e(route('profile')); ?>">Michael Sullivan</a></h4>
                    ...
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            <div class="doctor-img">
                                <a class="avatar" href="<?php echo e(route('profile')); ?>"><img alt="" src="img/doctor-thumb-02.jpg"></a>
                            </div>
                            <div class="dropdown profile-action">
                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <h4 class="doctor-name text-ellipsis"><a href="<?php echo e(route('profile')); ?>">Linda Barrett</a></h4>
                    ...
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            <div class="doctor-img">
                                <a class="avatar" href="<?php echo e(route('profile')); ?>"><img alt="" src="img/doctor-thumb-09.jpg"></a>
                            </div>
                            <div class="dropdown profile-action">
                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <h4 class="doctor-name text-ellipsis"><a href="<?php echo e(route('profile')); ?>">Ronald Jacobs</a></h4>
                    ...
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            <div class="doctor-img">
                                <a class="avatar" href="<?php echo e(route('profile')); ?>"><img alt="" src="img/doctor-thumb-01.jpg"></a>
                            </div>
                            <div class="dropdown profile-action">
                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <h4 class="doctor-name text-ellipsis"><a href="<?php echo e(route('profile')); ?>">Albert Sandoval</a></h4>
                    ...
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            <div class="doctor-img">
                                <a class="avatar" href="<?php echo e(route('profile')); ?>"><img alt="" src="img/doctor-thumb-05.jpg"></a>
                            </div>
                            <div class="dropdown profile-action">
                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <h4 class="doctor-name text-ellipsis"><a href="<?php echo e(route('profile')); ?>">Diana Bailey</a></h4>
                    ...
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            <div class="doctor-img">
                                <a class="avatar" href="<?php echo e(route('profile')); ?>"><img alt="" src="img/doctor-thumb-10.jpg"></a>
                            </div>
                            <div class="dropdown profile-action">
                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <h4 class="doctor-name text-ellipsis"><a href="<?php echo e(route('profile')); ?>">Shirley Willis</a></h4>
                    ...
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            <div class="doctor-img">
                                <a class="avatar" href="<?php echo e(route('profile')); ?>"><img alt="" src="img/doctor-thumb-08.jpg"></a>
                            </div>
                            <div class="dropdown profile-action">
                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <h4 class="doctor-name text-ellipsis"><a href="<?php echo e(route('profile')); ?>">Pamela Curtis</a></h4>
                    ...
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            <div class="doctor-img">
                                <a class="avatar" href="<?php echo e(route('profile')); ?>"><img alt="" src="img/doctor-thumb-06.jpg"></a>
                            </div>
                            <div class="dropdown profile-action">
                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <h4 class="doctor-name text-ellipsis"><a href="<?php echo e(route('profile')); ?>">Justin Parker</a></h4>
...
</html><?php /**PATH C:\xampp\htdocs\preclinic_laravel\resources\views/pages/doctor.blade.php ENDPATH**/ ?>