                            ...
                            <div class="email-content">
								<div class="table-responsive">
									<table class="table table-inbox table-hover">
										...
										<tbody>
											<tr class="unread clickable-row" data-href="<?php echo e(route('mail-veiw')); ?>">
												<td>
											...
											<tr class="clickable-row" data-href="<?php echo e(route('mail-veiw')); ?>">
												<td>
													<input type="checkbox" class="checkmail">
												</td>
												<td><span class="mail-important"><i class="fa fa-star-o"></i></span></td>
...
</html><?php /**PATH C:\xampp\htdocs\blog1\resources\views/pages/inbox.blade.php ENDPATH**/ ?>