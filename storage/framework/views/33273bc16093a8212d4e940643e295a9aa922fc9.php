					...
					<div class="row">
							...
							<div class="blog-view">
								<article class="blog blog-single-post">
									...
									<div class="blog-info clearfix">
										<div class="post-left">
											<ul>
												<li><a href="#."><i class="far fa-calendar-alt"></i> <span>December 6, 2017</span></a></li>
												<li><a href="#."><i class="fas fa-user"></i> <span>By Andrew Dawis</span></a></li>
											</ul>
										</div>
										<div class="post-right"><a href="#."><i class="far fa-comment"></i>1 Comment</a></div>
									</div>
						...
						<aside class="col-md-4">
							...
							<div class="widget post-widget">
								...
								<ul class="latest-posts">
									<li>
										...
										<div class="post-info">
											<h4>
												<a href="blog-details">Lorem ipsum dolor sit amet consectetur</a>
											</h4>
							...
							<div class="widget category-widget">
								...
								<ul class="categories">
									<li><a href="#."><i class="fas fa-long-arrow-alt-right"></i> Lorem ipsum dolor</a></li>
									<li><a href="#."><i class="fas fa-long-arrow-alt-right"></i> Lorem ipsum dolor</a></li>
									<li><a href="#."><i class="fas fa-long-arrow-alt-right"></i> Lorem ipsum dolor</a></li>
									<li><a href="#."><i class="fas fa-long-arrow-alt-right"></i> Lorem ipsum dolor</a></li>
									<li><a href="#."><i class="fas fa-long-arrow-alt-right"></i> Lorem ipsum dolor</a></li>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\medifab-laravel\admin-template\resources\views/blog-details.blade.php ENDPATH**/ ?>