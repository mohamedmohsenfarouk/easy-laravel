                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display: none;">
                                <li><a class="active" href="<?php echo e(route('blog')); ?>">Blog</a></li>
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-4 col-8 text-right m-b-30">
                        <a class="btn btn-primary btn-rounded float-right" href="<?php echo e(route('add-blog')); ?>"><i class="fa fa-plus"></i> Add Blog</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="blog grid-blog">
                            <div class="blog-image">
                                <a href="blog-details.html"><img class="img-fluid" src="img/blog/blog-01.jpg" alt=""></a>
                            </div>
                            <div class="blog-content">
                                <h3 class="blog-title"><a href="<?php echo e(route('blog-details')); ?>">Do You Know the ABCs of Health Care?</a></h3>
                                ...
                                <a href="<?php echo e(route('blog-details')); ?>" class="read-more"><i class="fa fa-long-arrow-right"></i> Read More</a>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="blog grid-blog">
                            <div class="blog-image">
                                <a href="<?php echo e(route('blog-details')); ?>"><img class="img-fluid" src="img/blog/blog-02.jpg" alt=""></a>
                            </div>
                            <div class="blog-content">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="blog grid-blog">
                            <div class="blog-image">
                                <a href="<?php echo e(route('blog-details')); ?>"><img class="img-fluid" src="img/blog/blog-03.jpg" alt=""></a>
                            </div>
                            <div class="blog-content">
                                <h3 class="blog-title"><a href="<?php echo e(route('blog-details')); ?>">Do You Know the ABCs of Health Care?</a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed do eiusmod tempor incididunt ut labore etmis dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco sit laboris.</p>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="blog grid-blog">
                            <div class="blog-image">
                                <a href="<?php echo e(route('blog-details')); ?>"><img class="img-fluid" src="img/blog/blog-04.jpg" alt=""></a>
                            </div>
                            <div class="blog-content">
                                <h3 class="blog-title"><a href="<?php echo e(route('blog-details')); ?>">Do You Know the ABCs of Health Care?</a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed do eiusmod tempor incididunt ut labore etmis dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco sit laboris.</p>
...
</html><?php /**PATH C:\xampp\htdocs\blog1\resources\views/pages/blog.blade.php ENDPATH**/ ?>