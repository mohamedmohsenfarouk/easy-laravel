									...
									<div class="navbar">
										<div class="user-details mr-auto">
											...
											<div class="user-info float-left">
												<a href="profile"><span>Mike Litorus</span></a>
								...
								<div class="chat-contents">
									<div class="chat-content-wrap">
										<div class="voice-call-avatar">
											<img src="img/profiles/avatar-02.jpg" alt="" class="call-avatar">
										...
										<div class="call-users">
											<ul>
												<li>
													<a href="#">
														<img src="img/profiles/avatar-03.jpg" class="img-fluid" alt="">
														<span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
													</a>
												</li>
												<li>
													<a href="#">
														<img src="img/profiles/avatar-08.jpg" class="img-fluid" alt="">
														<span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
													</a>
												</li>
												<li>
													<a href="#">
														<img src="img/profiles/avatar-05.jpg" class="img-fluid" alt="">
														<span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
													</a>
												</li>
											</ul>
													...
													<div class="chat chat-left">
														<div class="chat-avatar">
															<a href="profile" class="avatar">
																<img alt="John Doe" src="img/profiles/avatar-02.jpg">
															</a>
														</div>
														<div class="chat-body">
								...
								<div>
									...
									<ul class="chat-user-list">
										<li>
											<a href="#">
												<div class="media">
													<span class="avatar align-self-center"><img alt="" src="img/profiles/avatar-16.jpg"></span>
										...
										<li>
											<a href="#">
												<div class="media ">
													<span class="avatar align-self-center"><img alt="" src="img/profiles/avatar-13.jpg"></span>
													<div class="media-body align-self-center text-nowrap">
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\smarthr_laravel\resources\views/voice-call.blade.php ENDPATH**/ ?>