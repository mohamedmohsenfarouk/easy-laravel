				...
				<div class="content">
					<div class="row">
						...
						<div class="col-sm-7 col-8 text-right m-b-30">
							<a href="add-provident-fund" class="btn btn-primary btn-rounded"><i class="fas fa-plus"></i> Add Provident Fund</a>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
										...
										<tr>
											...
											<td class="text-right">
												<div class="dropdown dropdown-action">
													...
													<div class="dropdown-menu dropdown-menu-right">
														<a class="dropdown-item" href="edit-provident-fund"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a>
														<a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_pf"><i class="fas fa-trash m-r-5"></i> Delete</a>
													</div>
												</div>
											</td>
										</tr>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\medifab-laravel\admin-template\resources\views/provident-fund.blade.php ENDPATH**/ ?>