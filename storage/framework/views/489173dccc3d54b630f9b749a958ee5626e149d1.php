									...
									<div class="navbar">
										<div class="user-details mr-auto">
											<div class="float-left user-img m-r-10">
												<a href="profile" title="Mike Litorus"><img src="assets/img/user.jpg" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
											</div>
											<div class="user-info float-left">
												<a href="profile" title="Mike Litorus"><span class="font-bold">Mike Litorus</span></a>
												<span class="last-seen">Online</span>
											</div>
										</div>
										<ul class="nav custom-menu">
											<li class="nav-item">
												<a class="task-chat profile-rightbar float-right" href="#chat_sidebar"><i aria-hidden="true" class="fa fa-comments"></i></a>
											</li>
								...
								<div class="chat-contents">
									<div class="chat-content-wrap">
										<div class="voice-call-avatar">
											<img src="assets/img/doctor-thumb-03.jpg" alt="" class="call-avatar">
										...
										<div class="call-users">
											<ul>
												<li>
													<a href="">
													<img src="assets/img/doctor-thumb-03.jpg" class="img-fluid" alt="">
													<span class="call-mute"><i class="fas fa-microphone-slash"></i></span>
													</a>
												</li>
												<li>
													<a href="">
															...
															<div class="chats">
																...
																<div class="chat chat-left">
																	...
																	<div class="chat-body">
																		<div class="chat-bubble">
																			<div class="chat-content">
																				<span class="task-chat-user">John Doe</span> <span class="file-attached">attached 3 files <i class="fas fa-paperclip"></i></span> <span class="chat-time">Dec 17, 2014 at 4:32am</span>
																				<ul class="attach-list">
																					<li><i class="far fa-file"></i> <a href="#">project_document.avi</a></li>
																					<li><i class="far fa-file"></i> <a href="#">video_conferencing.psd</a></li>
																					<li><i class="far fa-file"></i> <a href="#">landing_page.psd</a></li>
																				</ul>
																			</div>
																		</div>
																	</div>
																...
																<div class="chat chat-left">
																	...
																	<div class="chat-body">
																		<div class="chat-bubble">
																			<div class="chat-content">
																				<span class="task-chat-user">Jeffery Lalor</span> <span class="file-attached">attached file <i class="fas fa-paperclip"></i></span> <span class="chat-time">Yesterday at 9:16pm</span>
																				<ul class="attach-list">
																...
																<div class="chat chat-left">
																	...
																	<div class="chat-body">
																		<div class="chat-bubble">
																			<div class="chat-content">
																				<span class="task-chat-user">Jeffery Lalor</span> <span class="file-attached">attached file <i class="fas fa-paperclip"></i></span> <span class="chat-time">Today at 12:42pm</span>
																				<ul class="attach-list">
																					<li class="img-file">
													...
													<div class="message-inner">
														...
														<div class="message-area">
															<div class="input-group">
																...
																<button class="btn btn-primary" type="button"><i class="far fa-paper-plane"></i></button>
																</span>
															</div>
														</div>
													</div>
												...
												<div class="table-body">
													<div class="table-content">
														<div class="chat-profile-img">
															...
															<a href="edit-profile" class="btn btn-primary edit-btn"><i class="fas fa-pencil-alt"></i></a>
														</div>
									...
									<ul class="upload-list">
										<li class="file-list">
											<div class="upload-wrap">
												<div class="file-name">
													<i class="fas fa-portrait"></i> photo.png
												</div>
										...
										<li class="file-list">
											<div class="upload-wrap">
												<div class="file-name">
													<i class="far fa-file"></i> task.doc
												</div>
										...
										<li class="file-list">
											<div class="upload-wrap">
												<div class="file-name">
													<i class="fas fa-portrait"></i> dashboard.png
												</div>
					...
					<div class="modal-body">
						<div class="profile-widget">
							<div class="profile-img">
								<a href="client-profile" class="avatar"><img src="assets/img/user-03.jpg" alt=""></a>
							</div>
							<h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="client-profile">Tressa Wexler</a></h4>
							<div class="small text-muted">calling ...</div>
							<div class="incoming-btns">
								<a href="chat" class="btn btn-success m-r-10">Decline</a>
								<a href="client-profile" class="btn btn-danger">Answer</a>
							</div>
						</div>
					</div>
				</div>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\medifab-laravel\admin-template\resources\views/incoming-call.blade.php ENDPATH**/ ?>