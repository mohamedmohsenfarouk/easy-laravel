                    ...
                    <ul>
						...
						<li class="submenu">
							...
							<ul style="display: none;">
								...
								<li><a class="active" href="<?php echo e(route('expenses')); ?>">Expenses</a></li>
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-4 col-7 text-right m-b-30">
                        <a href="<?php echo e(route('add-expense')); ?>" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Expense</a>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-striped custom-table mb-0 datatable">
                                <thead>
                                    <tr>
                                        <th style="font-size:0.875rem !important;">Item</th>
                                        <th style="font-size:0.875rem !important;">Purchase From</th>
                                        <th style="font-size:0.875rem !important;">Purchase Date</th>
                                        <th style="font-size:0.875rem !important;">Purchased By</th>
                                        <th style="font-size:0.875rem !important;">Amount</th>
                                        <th style="font-size:0.875rem !important;">Paid By</th>
                                        <th style="font-size:0.875rem !important;" class="text-center">Status</th>
                                        <th style="font-size:0.875rem !important;" class="text-right">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td style="font-size:0.875rem !important;">
                                            <strong>Stretcher</strong>
                                        </td>
                                        <td style="font-size:0.875rem !important;">Hospital Equipment Inc</td>
                                        <td style="font-size:0.875rem !important;">17 Aug 2018</td>
                                        <td style="font-size:0.875rem !important;">Loren Gatlin</td>
                                        <td style="font-size:0.875rem !important;">$8048</td>
                                        <td style="font-size:0.875rem !important;">Cash</td>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="<?php echo e(route('edit-expense')); ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size:0.875rem !important;">Biomedical Equipment Inc</td>
                                        <td style="font-size:0.875rem !important;">22 Jun 2018</td>
                                        <td style="font-size:0.875rem !important;">Tarah Shropshire</td>
                                        <td style="font-size:0.875rem !important;">$62480</td>
                                        <td style="font-size:0.875rem !important;">Cheque</td>
                                        <td class="text-center">
                                            <div class="dropdown action-label">
									...
									<tr>
                                        ...
                                        <td style="font-size:0.875rem !important;">Medi Pro Service</td>
                                        <td style="font-size:0.875rem !important;">24 Jul 2018</td>
                                        <td style="font-size:0.875rem !important;">Tarah Shropshire</td>
                                        <td style="font-size:0.875rem !important;">$3250</td>
                                        <td style="font-size:0.875rem !important;">Cheque</td>
                                        <td class="text-center">
                                            <div class="dropdown action-label">
                                                <a class="custom-badge status-green dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false">
...
</html><?php /**PATH C:\xampp\htdocs\blog1\resources\views/pages/expenses.blade.php ENDPATH**/ ?>