...
<header class="header">
				<nav class="navbar navbar-expand-lg header-nav">
					...
					<div class="main-menu-wrapper">
						...
						<li class="<?php echo e(Request::is('http://localhost/doccure_admin/public/') ? 'active' : ''); ?>">
								<a href="http://localhost/doccure_admin/public/">Admin</a>
							</li>
			...
			<!-- /Header --><?php /**PATH C:\xampp\htdocs\doccure2_landing\resources\views/layout/partials/header.blade.php ENDPATH**/ ?>