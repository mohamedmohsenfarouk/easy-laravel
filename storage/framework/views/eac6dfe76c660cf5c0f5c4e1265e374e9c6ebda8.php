                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
						...
						<li class="submenu">
							...
							<ul style="display: none;">
								<li><a class="active" href="<?php echo e(route('salary')); ?>"> Employee Salary </a></li>
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-7 text-right m-b-30">
                        <a href="<?php echo e(route('add-salary')); ?>" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Salary</a>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped custom-table datatable">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
											<img class="rounded-circle" src="img/user.jpg" height="28" width="28" alt=""> John Doe
                                        </td>
                                        <td>FT-0001</td>
                                        ...
                                        <td>$59698</td>
                                        <td><a class="btn btn-sm btn-primary" href="<?php echo e(route('salary-veiw')); ?>">Generate Slip</a></td>
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="<?php echo e(route('edit-salary')); ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
...
</html><?php /**PATH C:\xampp\htdocs\blog1\resources\views/pages/salary.blade.php ENDPATH**/ ?>