								...
								<div class="chat-contents">
									<div class="chat-content-wrap">
										...
										<div class="my-video">
											<ul>
												<li>
													<img src="img/profiles/avatar-01.jpg" class="img-fluid" alt="">
												</li>
											</ul>
										</div>
									</div>
											...
											<div class="chat-box">
												<div class="chats">
													...
													<div class="chat chat-left">
														<div class="chat-avatar">
															<a href="profile" class="avatar">
																<img alt="" src="img/profiles/avatar-09.jpg" class="img-fluid rounded-circle">
															</a>
														</div>
														<div class="chat-body">
															<div class="chat-bubble">
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\smarthr_laravel\resources\views/video-call.blade.php ENDPATH**/ ?>