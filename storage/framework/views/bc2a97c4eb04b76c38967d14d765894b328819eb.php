            ...
            <div class="sidebar-inner slimscroll">
                <div class="sidebar-menu">
                    <ul>
                        ...
                        <li class="active">
                            <a href="<?php echo e(route('chat')); ?>"><span class="chat-avatar-sm user-img"><img src="img/user.jpg" alt="" class="rounded-circle"><span class="status online"></span></span> Jennifer <span class="badge badge-pill bg-danger float-right">108</span></a>
                        </li>
                    </ul>
                </div>
            </div>
								...
								<div class="navbar">
                                    <div class="user-details mr-auto">
                                        <div class="float-left user-img m-r-10">
                                            <a href="<?php echo e(route('profile')); ?>" title="Jennifer Robinson"><img src="img/user.jpg" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
                                        </div>
                                        <div class="user-info float-left">
                                            <a href="<?php echo e(route('profile')); ?>" title="Jennifer Robinson"><span class="font-bold">Jennifer Robinson</span></a>
                            ...
                            <div class="chat-contents">
                                <div class="chat-content-wrap">
                                    <div class="voice-call-avatar">
                                        <img src="img/doctor-03.jpg" alt="" class="call-avatar">
                                    ...
                                    <div class="call-users">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img src="img/patient-thumb-02.jpg" class="img-fluid" alt="">
                                                    <span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <img src="img/patient-thumb-01.jpg" class="img-fluid" alt="">
                                                    <span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
                                                </a>
                                            </li>
                                        </ul>
                                            ...
                                            <div class="table-body">
                                                <div class="table-content">
                                                    <div class="chat-profile-img">
                                                        ...
                                                        <small class="text-muted">BMBS</small>
...
</html><?php /**PATH C:\xampp\htdocs\blog1\resources\views/pages/voice-cal.blade.php ENDPATH**/ ?>