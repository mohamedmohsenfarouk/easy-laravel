							...
							<div class="row">
									...
									<div class="card">
										...
										<div class="card-body">
											<div class="avatar avatar-xxl">
												<img class="avatar-img rounded-circle" alt="User Image" src="../assets_admin/img/profiles/avatar-12.jpg">
											</div>
								...
								<div class="col-md-12">
									<div class="card">
										...
										<div class="card-body">
											<div class="avatar">
												<img class="avatar-img rounded" alt="User Image" src="../assets_admin/img/profiles/avatar-12.jpg">
											</div>
											<div class="avatar">
												<img class="avatar-img rounded-circle" alt="User Image" src="../assets_admin/img/profiles/avatar-12.jpg">
											</div>
									...
									<div class="card">
										...
										<div class="card-body">
											<div class="avatar-group">
												<div class="avatar">
													<img class="avatar-img rounded-circle border border-white" alt="User Image" src="../assets_admin/img/profiles/avatar-12.jpg">
												</div>
												<div class="avatar">
													<img class="avatar-img rounded-circle border border-white" alt="User Image" src="../assets_admin/img/profiles/avatar-13.jpg">
												</div>
												<div class="avatar">
													<img class="avatar-img rounded-circle border border-white" alt="User Image" src="../assets_admin/img/profiles/avatar-14.jpg">
												</div>
												<div class="avatar">
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Mentoring_laravel\template\resources\views/admin/components.blade.php ENDPATH**/ ?>