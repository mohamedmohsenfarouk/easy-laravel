                    ...
                    <ul>
						...
						<li class="submenu">
							...
							<ul style="display: none;">
								...
								<li><a href="<?php echo e(route('taxex')); ?>">Taxes</a></li>
								<li><a class="active" href="<?php echo e(route('provident-fund')); ?>">Provident Fund</a></li>
							</ul>
						</li>
						<li class="submenu">
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-7 col-8 text-right m-b-30">
                        <a href="<?php echo e(route('add-provident-fund')); ?>" class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Add Provident Fund</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            <h2><a href="<?php echo e(route('profile')); ?>">Albina Simonis  <span> Nurse</span></a></h2>
                                        </td>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="<?php echo e(route('edit-provident-fund')); ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
...
</html><?php /**PATH C:\xampp\htdocs\blog1\resources\views/pages/provident-fund.blade.php ENDPATH**/ ?>