									...
									<div class="navbar">
										<div class="user-details mr-auto">
											<div class="float-left user-img m-r-10">
												<a href="profile" title="Jennifer Robinson"><img src="assets/img/doctor-thumb-03.jpg" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
											</div>
										...
										<ul class="nav custom-menu">
											<li class="nav-item">
												<a href="#chat_sidebar" class="nav-link task-chat profile-rightbar float-right"><i class="fas fa-user"></i></a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="voice-call"><i class="fas fa-phone"></i></a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="video-call"><i class="fas fa-video"></i></a>
											</li>
												...
												<div class="chats">
													...
													<div class="chat chat-left">
														<div class="chat-avatar">
															...
															<img alt="Jennifer Robinson" src="assets/img/doctor-thumb-03.jpg" class="img-fluid rounded-circle">
															</a>
														</div>
														<div class="chat-body">
															<div class="chat-bubble">
															...
															<div class="chat-bubble">
																<div class="chat-content">
																	...
																	<ul class="attach-list">
																		<li><i class="far fa-file"></i> <a href="#">example.avi</a></li>
																		<li><i class="far fa-file"></i> <a href="#">activity.psd</a></li>
																		<li><i class="far fa-file"></i> <a href="#">example.psd</a></li>
																	</ul>
																</div>
															</div>
															<div class="chat-bubble">
												...
												<div class="chats">
													...
													<div class="chat chat-left">
														...
														<div class="chat-body">
															<div class="chat-bubble">
																<div class="chat-content">
																	<span class="task-chat-user">Jennifer Robinson</span> <span class="chat-time">8:35 am</span>
																	<div class="call-details">
												...
												<div class="table-body">
													<div class="table-content">
														<div class="chat-profile-img">
															...
															<h3 class="user-name m-t-10 m-b-0">Cristina Groves</h3>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\medifab-laravel\admin-template\resources\views/chat.blade.php ENDPATH**/ ?>