								...
								<div class="activity-box">
									<ul class="activity-list">
										...
										<li>
											...
											<div class="activity-content">
												<div class="timeline-content">
													<a href="profile" class="name">Jeffery Lalor</a> added <a href="profile" class="name">Jeffrey Warden</a> and <a href="profile" class="name">Bernardo Galaviz</a> to the task of <a href="#">Private chat module</a>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\medifab-laravel\admin-template\resources\views/activities.blade.php ENDPATH**/ ?>